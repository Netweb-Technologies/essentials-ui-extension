...
// const REAL_PRODUCT = '/harvester';
// const DISPLAY_PRODUCT = '/skylus-essentials';

// export function toDisplayPath(path) {
//   return path?.startsWith(REAL_PRODUCT)
//     ? path.replace(REAL_PRODUCT, DISPLAY_PRODUCT)
//     : path;
// }
...
export function getProductFromRoute(to) {
  ...
  if (to?.path?.startsWith('/skylus-essentials')) {
    return 'harvester';
  }
