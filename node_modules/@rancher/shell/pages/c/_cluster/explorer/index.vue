...
<template>
  ...
  <!-- Add these if using Harvester -->
  <ResourceSummary resource="harvesterhci.io.virtualmachine" />
  <ResourceSummary resource="harvesterhci.io.volume" />
  <ResourceSummary resource="harvesterhci.io.image" />
  <ResourceSummary resource="harvesterhci.io.network" />
</div>
...
/* Make hardware cards modern */
.hardware-resource-gauges :deep(.simple-box) {
