...
fleet:
  ...
  clusters:
    harvester: |-
      There {count, plural,
      =1 {is 1 Skylus Essentials cluster that is hidden as this can not be used with Continuous Delivery}
      other {are # Skylus Essentials clusters that are hidden as they can not be used with Continuous Delivery}
      }
  tokens:
    harvester: |-
      {count, plural,
      =1 {1 token is hidden as it belongs to a Skylus Essentials cluster that can not be used with Continuous Delivery}
      other {# tokens are hidden as they belong to Skylus Essentials clusters that can not be used with Continuous Delivery}
      }
  bundles:
    resources: Resources
    harvester: |-
      {count, plural,
      =1 {1 bundle is hidden as it belongs to a Skylus Essentials cluster that can not be used with Continuous Delivery}
      other {# bundles are hidden as they belong to Skylus Essentials clusters that can not be used with Continuous Delivery}
      }
  fleetSummary:
    noClusters:
...
landing:
  ...
  whatsNew:
    title: Welcome to Skylus Essentials {version}
  ...
  welcomeToRancher: 'Welcome to Skylus Essentials'
...
login:
  login: Login
  howdy: Hi!
  welcome: Welcome to Skylus Essentials
  landscapeAlt: Landscape image
  loggedOut: You have been logged out.
  loggedOutSessionIdle: You've been logged out of Skylus Essentials because your session has expired. Log in again to continue.
  loggedOutFromSso: You've been logged out of Skylus Essentials, however you may still be logged in to your single sign-on identity provider.
  loggedOutFromSlo: You've been logged out of Skylus Essentials and from your single sign-on identity provider.
...
members:
  ...
  localClusterWarning: "Caution: This is the cluster that Skylus Essentials is using as a data store. Only administrators should be given write access to this cluster. Users with write access to this cluster can use it to grant themselves access to any part of this installation."
...
persistentVolume:
  ...
  csi:
    ...
    drivers:
      ...
      driver-longhorn-io: Essentials Block (CSI)
      driver-harvesterhci-io: Essentials Block (CSI)
...
storageClass:
  ...
  harvesterhci:
    title: Skylus Essentials (CSI)
    warning:
      unSatisfiesVersion: Please upgrade your Skylus Essentials CSI driver version to use this feature. (csi-driver >= v0.1.15)
    hostStorageClass:
      label: Host Storage Class
      placeholder: Storage class name on the host Skylus Essentials cluster
      tooltip: By default the default storage class on the host Skylus Essentials cluster is used.
